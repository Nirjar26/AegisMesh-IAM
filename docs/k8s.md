...
Bastion deploys onto a GitOps-managed **k3s** Kubernetes cluster.

---

## 1. Segmentation & Namespaces

- `Bastion`: Core runtimes (API gateway, dashboard frontend, ML security engine, PostgreSQL database).
