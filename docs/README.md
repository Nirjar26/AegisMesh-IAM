# Bastion: IAM Documentation Portal

Welcome to the central documentation hub for **Bastion**, a high-assurance, self-hosted Identity and Access Management (IAM) platform. This project integrates traditional policy-driven authorization with cutting-edge ML-based threat intelligence and a robust GitOps pipeline.
