...
Bastion enforces a Zero-Trust architecture where no user or service is trusted by default.
...
- **Namespace Isolation:** Services are partitioned into `Bastion`, `monitoring`, and `security` namespaces.
