    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in-up">
            <div className="space-y-6">
                <div>
                    <h3 className="text-lg font-bold text-[#0f1623] mb-4 border-b border-[#d0d7e8] pb-2">
                        User Details
                    </h3>
                    <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                        <div>
                            <dt className="text-xs text-[#7a87a8] font-medium uppercase mb-1">
                                First Name
                            </dt>
                    ...
                    {groups.length > 0 ? (
                        <div className="flex flex-wrap gap-2">
                            {groups.map((g) => (
                                <div
                                    key={g.id}
                                    className="bg-[#ffffff] border border-[#d0d7e8] px-3 py-1.5 rounded-lg text-sm text-[#3a4560] flex items-center gap-2"
                                >
                        ...
                        <p className="text-[#7a87a8] text-sm italic">
