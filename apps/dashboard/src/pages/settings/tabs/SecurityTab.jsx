...
import { AlertTriangle, Lock, Monitor, ShieldCheck, Smartphone } from 'lucide-react';
        ...
        <div className="w-full space-y-5">
            <CardShell>
                <CardHeader
                    ...
                    title="Password"
                    right={
                        <span className="text-xs text-[#7a87a8]">
                ...
                {user?.mfaEnabled ? (
                    <div className="px-6 py-5 space-y-4">
                        <div className="bg-[#16a34a]/5 border border-[#16a34a]/15 rounded-xl px-4 py-3">
                            <p className="text-[13px] text-[#1f5e34]">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    if (password) regenCodesMutation.mutate({ password });
                                }}
                        ...
                        {showDisablePrompt ? (
                            <div className="border border-[#d0d7e8] rounded-xl p-3 bg-[#f8f9fd]">
                                <label
                                    ...
                                    className="text-xs text-[#7a87a8] block mb-1"
                                >
                                    Confirm password
                                </label>
                                <div className="flex gap-2">
                    ...
                    <div className="px-6 py-5">
                        <div className="bg-[#dc2626]/5 border border-[#dc2626]/15 rounded-xl px-4 py-3 flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-[13px] text-[#7a1b1b]">
            ...
            <CardShell>
                ...
                <div>
                    {trustedDevices.map((device) => (
                        <div
                            key={device.id}
                            className="px-6 py-3.5 border-b border-[#f0f2f8] last:border-0 flex items-center justify-between"
                        >
                            <div className="flex items-center gap-3">
                                <div className="bg-[#f4f6fb] rounded-lg p-1.5">
                                    {String(device.device || '')
                                        .toLowerCase()
                                        .includes('mobile') ? (
                                        <Smartphone size={14} className="text-[#7a87a8]" />
                                    ) : (
                                        <Monitor size={14} className="text-[#7a87a8]" />
                                    )}
                                </div>
                                <div>
                                    <p className="text-sm text-[#0f1623]">
                    ...
                    {trustedDevices.length === 0 ? (
                        <div className="px-6 py-4 text-sm text-[#7a87a8]">
                                ...
                                {otpDigits.map((digit, index) => (
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (clean && index < 5)
                                                document
                                                    .getElementById(OTP_INPUT_IDS[index + 1])
                                                    ?.focus();
                                        }}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {revealedBackupCodes.map((code) => (
                                    <div
                                        key={code}
                                        className="font-mono text-sm bg-[#f4f6fb] border border-[#d0d7e8] rounded-lg px-4 py-2 text-center"
                                    >
                                        {code}
                                    </div>
                                ))}
