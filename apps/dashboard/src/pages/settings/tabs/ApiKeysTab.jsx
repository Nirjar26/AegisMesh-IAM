        ...
        <div className="w-full">
            <div className="flex items-center justify-between mb-5">
                <div>
                    ...
                    <p className="text-xs text-[#7a87a8] mt-0.5">
            ...
            <CardShell>
                ...
                <div>
                    {apiKeys.map((token) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div>
                                    <span className="font-mono text-xs bg-[#f4f6fb] px-2 py-0.5 rounded border border-[#d0d7e8]">
                                        {token.tokenPrefix}
                                    </span>
                                </div>
                                <div className="flex flex-wrap gap-1">
                                    {token.scopes?.map((scope) => (
                                        <span
                                            key={scope}
                                            className="bg-[#4f46e5]/8 text-[#4f46e5] text-[10px] px-2 py-0.5 rounded-full"
                                        >
                                            {scope}
                                        </span>
                                    ))}
                                ...
                                <div className="text-xs text-[#7a87a8] flex items-center gap-2">
                                    ...
                                    {expired ? (
                                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#dc2626]/10 text-[#dc2626]">
                                            Expired
                                        </span>
                                    ) : null}
                                </div>
                    ...
                    {apiKeys.length === 0 ? (
                        <div className="px-5 py-6 text-sm text-[#7a87a8]">
                ...
                <Modal title="Create API Key" icon={Key} onClose={() => setShowModal(false)}>
                    {createdToken ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <p className="text-xs text-[#7a87a8] font-medium block mb-2">
                                    Scopes
                                </p>
                                            ...
                                            >
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        checked={checked}
                                                    />
                                                    <span className="text-sm font-medium text-[#0f1623]">
                                                        {scope.value}
                                                    </span>
                                                </div>
