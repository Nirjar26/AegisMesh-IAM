                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="col-span-2">
                        <label
                            ...
                            className="text-xs text-[#7a87a8] font-medium mb-1 block"
                        >
                            Email
                        </label>
                        <div className="relative">
                            ...
                            <Lock
                                size={14}
                                className="absolute right-12 top-1/2 -translate-y-1/2 text-[#7a87a8]"
                            />
                            <button
                                type="button"
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#4f46e5] hover:underline"
                            >
                                Change Email
                            </button>
                        </div>
