...
import { ChevronDown, ChevronLeft, ChevronUp, Loader2, ShieldCheck, X } from 'lucide-react';
...
export default function ApplyTemplateModal({ template, onBack, onClose, onSuccess }) {
    ...
    const policyToggleIcon = showPolicies ? ChevronUp : ChevronDown;

    const PolicyToggleIcon = policyToggleIcon;
