...
export default function AuditLogFilters({ filters, onChange }) {
    ...
    return (
        ...
        >
            ...
            <div>
                <label htmlFor="audit-filter-search" style={labelStyle}>
                    Search
                </label>
                <input
            ...
            <div>
                <label htmlFor="audit-filter-category" style={labelStyle}>
                    Category
                </label>
                <select
            ...
            <div>
                <label htmlFor="audit-filter-result" style={labelStyle}>
                    Result
                </label>
                <select
            ...
            <div>
                <label htmlFor="audit-filter-start-date" style={labelStyle}>
                    Start Date
                </label>
                <input
            ...
            <div>
                <label htmlFor="audit-filter-end-date" style={labelStyle}>
                    End Date
                </label>
                <input
            ...
            <div>
                <label htmlFor="audit-filter-ip" style={labelStyle}>
                    IP Address
                </label>
                <input
                    id="audit-filter-ip"
            ...
            <div style={{ display: 'flex', gap: '8px', marginTop: '4px' }}>
                <button type="button" onClick={() => onChange({})} style={resetBtnStyle}>
                    Reset
                </button>
            </div>
        </div>
