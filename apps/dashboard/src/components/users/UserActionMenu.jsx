            ...
            {isOpen && (
                <div className="absolute right-0 mt-1 w-48 bg-[#f4f6fb] border border-[#d0d7e8] rounded-lg shadow-xl z-50 py-1 font-medium overflow-hidden animate-fade-in-up">
                    <button
                        ...
                        className="w-full text-left px-4 py-2 text-sm text-[#3a4560] hover:bg-[#dde2f0] hover:text-[#0f1623] flex items-center gap-2"
                    >
                    ...
                    {(user.status === 'INACTIVE' || user.status === 'LOCKED') && (
                        <button
                            ...
                            className="w-full text-left px-4 py-2 text-sm text-green-400 hover:bg-[#dde2f0] flex items-center gap-2"
                        >
                    ...
                    {user.status === 'ACTIVE' && (
                        <button
                            ...
                            className="w-full text-left px-4 py-2 text-sm text-[#4f46e5] hover:bg-[#dde2f0] flex items-center gap-2"
                        >
                    ...
                    {!user.emailVerified && (
                        <button
                            onClick={(e) => handleAction(e, 'verify-email')}
                            className="w-full text-left px-4 py-2 text-sm text-[#4f46e5] hover:bg-[#dde2f0] flex items-center gap-2"
                        >
                    ...
                    <button
                        onClick={(e) => handleAction(e, 'reset-password')}
                        className="w-full text-left px-4 py-2 text-sm text-[#3a4560] hover:bg-[#dde2f0] hover:text-[#0f1623] flex items-center gap-2"
                    >
                    ...
                    <button
                        ...
                        className="w-full text-left px-4 py-2 text-sm text-red-500 hover:bg-[#dde2f0] flex items-center gap-2"
                    >
