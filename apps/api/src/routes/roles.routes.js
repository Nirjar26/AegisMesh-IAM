...
router.post(
    ...
    authorize('roles:write', 'roles/*'),
    validate(schemas.roleTemplateApply),
    rolesController.applyTemplate,
);
...
router.post(
    '/:id/policies',
    authorize('roles:write', 'roles/*'),
    validate(schemas.rolePolicy),
    rolesController.attachPolicy,
);
router.delete(
    '/:id/policies/:policyId',
    authorize('roles:write', 'roles/*'),
    rolesController.detachPolicy,
);
