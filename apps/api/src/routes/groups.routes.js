...
router.post(
    '/',
    authorize('groups:write', 'groups/*'),
    validate(schemas.group),
...
router.post(
    '/:id/roles',
    authorize('groups:write', 'groups/*'),
    validate(schemas.groupRole),
    groupsController.attachRole,
);
router.delete(
    '/:id/roles/:roleId',
    authorize('groups:write', 'groups/*'),
    groupsController.detachRole,
);
