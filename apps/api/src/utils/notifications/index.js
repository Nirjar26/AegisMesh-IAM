...
const NOTIFICATION_BUILDERS = {
    ...
    USER_STATUS_CHANGED: authBuilders.buildUserStatusChangedNotification,
    ...
    ALL_OTHER_SESSIONS_REVOKED: settingsBuilders.buildAllOtherSessionsRevokedNotification,
    ALL_SESSIONS_REVOKED: settingsBuilders.buildAllSessionsRevokedNotification,
    ...
    CONNECTED_APP_REVOKED: settingsBuilders.buildConnectedAppRevokedNotification,
    TRUSTED_DEVICE_REVOKED: settingsBuilders.buildTrustedDeviceRevokedNotification,
    ALL_TRUSTED_DEVICES_REVOKED: settingsBuilders.buildAllTrustedDevicesRevokedNotification,
};
    ...
    try {
        ...
        return prisma.notificationLog.create({
            data: {
                ...
                title: String(notification.title || 'Activity update')
                    .trim()
                    .slice(0, 120),

                message: normalizeMessage(
                    notification.message || 'An important account event occurred.',
                ),
