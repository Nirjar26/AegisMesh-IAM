...
const auditRole = {
    ...
    assigned: (req, roleId, targetUserId) =>
        audit({
            req,
    ...
    removed: (req, roleId, targetUserId) =>
        audit({
            req,
            action: 'ROLE_REMOVED',
            category: 'ROLE_MANAGEMENT',
...
const auditPolicy = {
    created: (req, policyId, policyName) =>
        audit({
            req,
    ...
    deleted: (req, policyId, policyName) =>
        audit({
            req,
    ...
    simulated: (req, userId, action, resource, simResult) =>
        audit({
            req,
...
const auditGroup = {
    ...
    memberAdded: (req, groupId, memberId) =>
        audit({
            req,
    ...
    memberRemoved: (req, groupId, memberId) =>
        audit({
            req,
    ...
    roleAttached: (req, groupId, roleId) =>
        audit({
            req,
    ...
    roleDetached: (req, groupId, roleId) =>
        audit({
            req,
...
const auditPermission = {
    checked: (req, userId, action, resource, permissionResult) => {
        const resultDetails =
            typeof permissionResult === 'object' && permissionResult !== null
                ? permissionResult
    ...
    denied: (req, userId, action, resource, permissionResult = null) =>
        audit({
            req,
            userId,
