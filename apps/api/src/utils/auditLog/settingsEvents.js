...
const auditUser = {
    ...
    statusChanged: (req, userId, email, from, to) =>
        audit({
            req,
    ...
    emailVerified: (req, userId, email) =>
        audit({
            req,
    ...
    sessionsRevoked: (req, userId, email, count) =>
        audit({
            req,
