...
const p = (name, description, effect, actions, resources) => ({
    name,
    description,
    effect,
    actions,
...
const policy = {
    denyAdmin: p(
        ...
        DENY,
        ['roles:*', 'policies:*', 'users:delete', 'org:*'],
        ['*'],
    ),
    denyDestructive: p(
        'Deny-Destructive',
        ...
        DENY,
        ['users:delete', 'roles:write', 'policies:write', 'org:*'],
        ['*'],
    ),
    denyAllWrite: p(
        'Deny-AllWrite',
    ...
    denyWriteUsers: p(
        'Deny-WriteUsers',
        'Block all user write operations',
        DENY,
        ['users:write', 'users:delete', 'roles:*', 'policies:*'],
        ['*'],
    ),
...
const ROLE_TEMPLATES = [
    {
        ...
        badgeColor: 'blue',
        useCase:
            'Perfect for auditors, stakeholders, or new team members who need visibility without write access',
        estimatedPolicies: 4,
    ...
    },
    {
        ...
        badgeColor: 'indigo',
        useCase:
            'For engineering team members who need API key access and system visibility without admin risk',
        estimatedPolicies: 4,
        policies: [
            p(
                'Dev-APIKeys',
            ...
            p(
                'Dev-ReadResources',
                'Read all system resources',
                ALLOW,
                ['users:read', 'roles:read', 'groups:read'],
                ['*'],
            ),
            policy.readAudit,
    ...
    },
    {
        ...
        badgeColor: null,
        useCase:
            'For support teams who need to look up users, view account status, and assist with issues',
        estimatedPolicies: 3,
        policies: [
            policy.readUsers,
            p(
                'Support-ManageStatus',
                'Lock/unlock + verify emails',
                ALLOW,
                ['users:write'],
                ['users/*/status', 'users/*/verify-email'],
            ),
            policy.denyAdmin,
        ],
        permissions: [
    ...
    },
    {
        ...
        policies: [
            ...
            p(
                'Billing-Export',
                'Export audit and org data',
                ALLOW,
                ['audit:export', 'org:export'],
                ['audit/*', 'org/export'],
            ),
    ...
    },
    {
        ...
        badgeColor: 'red',
        useCase:
            'For compliance officers or security teams conducting audits, incident investigations, or compliance reviews',
        estimatedPolicies: 3,
        policies: [
            policy.readAll,
            p(
                'Auditor-AuditExport',
                'Export and stream audit logs',
                ALLOW,
                ['audit:export', 'audit:stream'],
                ['audit/*'],
            ),
            policy.denyAllWrite,
        ],
        ...
        restrictions: ['Strictly read-only', 'Cannot modify anything at all'],
    },
    {
        id: 'group_manager',
        name: 'Group Manager',
        ...
        badgeColor: null,
        useCase:
            'For team leads or HR who need to manage team membership without broader admin access',
        estimatedPolicies: 3,
        policies: [
            p(
                'GroupMgr-ManageGroups',
                'Full CRUD on groups',
                ALLOW,
