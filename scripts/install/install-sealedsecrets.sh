...
echo "  kubeseal --controller-namespace ${NAMESPACE} --format yaml < platform/kubernetes/manifests/secret.yaml > platform/kubernetes/overlays/prod/sealedsecret-Bastion.yaml"
