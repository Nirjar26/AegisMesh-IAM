...
This directory contains the Terraform configuration for provisioning the Bastion cloud environment.

## Resources

- **ECR Repositories:** Managed private repositories for `bastion-backend`, `bastion-frontend`, and `bastion-security-engine`.
